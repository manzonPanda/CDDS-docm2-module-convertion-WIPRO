...
for (int i=1; i<=tableRows.size()-1; i++){
	...
	if( businessUnit.getAttribute("innerText").contains(findTestData('CDDS/DOCM1_Module_TestData/Create_Folder').getValue('BusinessUnit', 2)) 
		&& title.getAttribute("innerText").contains(findTestData('CDDS/DOCM1_Module_TestData/Create_Folder').getValue('FolderTitle', 2)) 
		&& description.getAttribute("innerText").contains(findTestData('CDDS/DOCM1_Module_TestData/Create_Folder').getValue('FolderDescription', 2))
	){
