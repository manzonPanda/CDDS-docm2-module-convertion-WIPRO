...
for (int i=1; i<=tableRows.size()-1; i++){
	...
	if( businessUnit.getAttribute("innerText").contains(findTestData('CDDS/DOCM1_Module_TestData/Create_Folder').getValue('BusinessUnit', 3)) 
		&& title.getAttribute("innerText").contains(findTestData('CDDS/DOCM1_Module_TestData/Create_Folder').getValue('FolderTitle', 3)) 
		&& description.getAttribute("innerText").contains(findTestData('CDDS/DOCM1_Module_TestData/Create_Folder').getValue('FolderDescription', 3))
	){
