...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/Verify _project/Type_Obj'), findTestData(
        'CDDS/BCM_Module_TestData/Generate_BCM_Element/GenerateAction_FromRequirement').getValue('Type', 1), false)

'Select statecheck'
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/Verify _project/StateCheck_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/Generate_BCM_Element/GenerateAction_FromRequirement').getValue('State', 1), false)
...
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/GenerateAction_FromBug/Comment_Obj'), findTestData(
        'CDDS/BCM_Module_TestData/Generate_BCM_Element/GenerateAction_FromRequirement').getValue('Comment', 1))
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/GenerateAction_FromBug/BCMPriority_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/Generate_BCM_Element/GenerateAction_FromRequirement').getValue('Priority', 1), 
    false)
...
WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/Generate_BCM_Element/verify_project'), [('Type') : findTestData(
            'CDDS/BCM_Module_TestData/Generate_BCM_Element/GenerateAction_FromRequirement').getValue('Typeselect', 1), ('State_type') : findTestData(
            'CDDS/BCM_Module_TestData/Generate_BCM_Element/GenerateAction_FromRequirement').getValue('State', 1), ('Keyword') : findTestData(
