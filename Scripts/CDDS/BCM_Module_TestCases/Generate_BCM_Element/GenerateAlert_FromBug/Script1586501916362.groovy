...
WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Login_With_Parameterized_ID'), [('Login_Id') : findTestData('CDDS/BCM_Module_TestData/Generate_BCM_Element/GenerateAlert_FromBug').getValue(
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/Verify _project/Type_Obj'), findTestData(
        'CDDS/BCM_Module_TestData/Generate_BCM_Element/GenerateAlert_FromBug').getValue('Type', 1), false)

'Select statecheck'
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/Verify _project/StateCheck_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/Generate_BCM_Element/GenerateAlert_FromBug').getValue('State', 1), false)
...
'Switch to  window'
WebUI.switchToWindowTitle(findTestData('CDDS/BCM_Module_TestData/Generate_BCM_Element/GenerateAlert_FromBug').getValue('Title', 
        1))
...
'Close the window'
WebUI.closeWindowTitle(findTestData('CDDS/BCM_Module_TestData/Generate_BCM_Element/GenerateAlert_FromBug').getValue('Title', 
...
WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/Generate_BCM_Element/verify_project'), [('Type') : findTestData(
            'CDDS/BCM_Module_TestData/Generate_BCM_Element/GenerateAlert_FromBug').getValue('Typeselect', 1), ('State_type') : findTestData(
            'CDDS/BCM_Module_TestData/Generate_BCM_Element/GenerateAlert_FromBug').getValue('State', 1), ('Keyword') : findTestData(
