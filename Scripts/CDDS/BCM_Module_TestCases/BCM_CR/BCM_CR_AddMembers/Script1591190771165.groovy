...
WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/BCM_CR/Navigate_to_Project'), [('ProjectName') : findTestData(
            'CDDS/BCM_Module_TestData/BCM_CR/Create_CRProject').getValue('ProjectName', 1)], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Bug_Add_Member'), [('SetMember') : findTestData('CDDS/BCM_Module_TestData/BCM_CR/BCM_CR_AddMembers').getValue(
            'UserID', 1)], FailureHandling.STOP_ON_FAILURE)
