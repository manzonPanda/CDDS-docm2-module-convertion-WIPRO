...
'Wait for  Select ProjectName  element to be visible'
WebUI.verifyElementText(ProjectNameObj1, ProjectName1, FailureHandling.OPTIONAL)
...
WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/BCM_Requirment_Edit_Functionality_Master/Common_TC_For_BCM_Module/Create_Requirement'), 
    [('On_Behalf_Of') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_New_State').getValue(
            'Requirement_Creation', 1), ('Title') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue(
...
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/Keyword_obj'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue(
...
def Approved_requirement = findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue(
    'Requirement_Creation', 1)

'creating  dynamic xpath to verify the Requirement title name '
String RequirementXpath = ('//td[contains(text(),"' + Approved_requirement) + '")]'
...
WebUI.verifyElementText(RequirementObj, Approved_requirement, FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/Assign_State_obj'), findTestData(
        'CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue('State', 
        1), false)
...
def Approved_requirement1 = findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue(
    'Requirement_Creation', 1)

'creating  dynamic xpath for verifying the requirement of assigned state'
String RequirementXpath1 = ('//td[contains(text(),"' + Approved_requirement1) + '")]'
...
WebUI.verifyElementText(RequirementObj1, Approved_requirement1, FailureHandling.STOP_ON_FAILURE)

println(RequirementObj1)

def status_Assigned = findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue(
    'State', 2)
...
WebUI.selectOptionByValue(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/StateDropdown_obj'), findTestData(
        'CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue('State', 
        4), false)
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/Classification_obj'), findTestData(
        'CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue('Clasification', 
        1), false)
...
WebUI.selectOptionByValue(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMDifficulty_obj'), findTestData(
        'CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue('Properties', 
        1), false)
...
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMImpactAreaMinimum'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue(
        'Properties', 3))
...
'Enter value for all mandatory fields'
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMImpactAreaMaximum'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue(
        'Properties', 4))
...
'Enter value for all mandatory fields'
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMImpactAreaTypical'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue(
        'Properties', 5))
...
'Enter value for all mandatory fields'
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMImpactCostMinimum'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue(
        'Properties', 6))
...
'Enter value for all mandatory fields'
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMImpactCostMaximum'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue(
        'Properties', 7))
...
'Enter value for all mandatory fields'
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMImpactCostTypical'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue(
        'Properties', 8))
...
'Enter value for all mandatory fields'
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMTechnicalProposal'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue(
        'Properties', 29))
...
'Enter value for all mandatory fields'
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMOtherImpacts'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue(
        'Properties', 31))
...
def Approved_requirement3 = findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue(
    'Requirement_Creation', 1)

String RequirementXpath3 = ('//td[contains(text(),"' + Approved_requirement3) + '")]'
...
WebUI.verifyElementText(RequirementObj3, Approved_requirement3, FailureHandling.STOP_ON_FAILURE)

println(RequirementObj3)

def status_Assigned3 = findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue(
    'State', 5)
...
'Wait for  Select ProjectName  element to be visible'
WebUI.verifyElementText(ProjectName2Obj, ProjectName2, FailureHandling.OPTIONAL)
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMPriority'), findTestData(
        'CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue('Properties_Approved_State', 
        1), false)
...
def Approved_requirement4 = findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue(
    'Requirement_Creation', 1)

String RequirementXpath4 = ('//td[contains(text(),"' + Approved_requirement4) + '")]'
...
'verify requirement  title'
WebUI.verifyElementText(RequirementObj4, Approved_requirement4, FailureHandling.STOP_ON_FAILURE)

println(RequirementObj4)

def status_Assigned4 = findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Approved_State').getValue(
    'State', 8)
