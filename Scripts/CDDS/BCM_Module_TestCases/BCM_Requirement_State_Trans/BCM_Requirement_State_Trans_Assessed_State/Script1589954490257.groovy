...
WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Login_With_Parameterized_ID'), [('Login_Id') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue(
...
WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/BCM_Requirment_Edit_Functionality_Master/Common_TC_For_BCM_Module/Create_Requirement'), 
    [('On_Behalf_Of') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_New_State').getValue(
            'Requirement_Creation', 1), ('Title') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue(
...
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/Keyword_obj'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue(
...
def Assigned_requirement = findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue(
    'Requirement_Creation', 1)
...
def Assigned_requirement1 = findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue(
    'Requirement_Creation', 1)

'creating  dynamic xpath for verifying the requirement of assigned state'
String RequirementXpath1 = ('//td[contains(text(),"' + Assigned_requirement1) + '")]'
...
WebUI.selectOptionByIndex(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/Classification_obj'), findTestData(
        'CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue('Clasification', 
        1), FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByValue(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMDifficulty_obj'), findTestData(
        'CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue('Properties', 
        1), false)
...
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMImpactAreaMinimum'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue(
        'Properties', 3))
...
'Enter value for all mandatory fields'
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMImpactAreaMaximum'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue(
        'Properties', 4))
...
'Enter value for all mandatory fields'
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMImpactAreaTypical'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue(
        'Properties', 5))
...
'Enter value for all mandatory fields'
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMImpactCostMinimum'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue(
        'Properties', 6))
...
'Enter value for all mandatory fields'
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMImpactCostMaximum'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue(
        'Properties', 7))
...
'Enter value for all mandatory fields'
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMImpactCostTypical'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue(
        'Properties', 8))
...
'Enter value for all mandatory fields'
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMTechnicalProposal'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue(
        'Properties', 29))
...
'Enter value for all mandatory fields'
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirement_State_Trans/BCMOtherImpacts'), findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue(
        'Properties', 31))
...
def Assigned_requirement3 = findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue(
    'Requirement_Creation', 1)

String RequirementXpath3 = ('//td[contains(text(),"' + Assigned_requirement3) + '")]'
...
WebUI.verifyElementText(RequirementObj3, Assigned_requirement3, FailureHandling.STOP_ON_FAILURE)

println(RequirementObj3)

def status_Assigned3 = findTestData('CDDS/BCM_Module_TestData/BCM_Requirement_State_Trans/BCM_Requirement_State_Trans_Assessed_State').getValue(
    'State', 3)
