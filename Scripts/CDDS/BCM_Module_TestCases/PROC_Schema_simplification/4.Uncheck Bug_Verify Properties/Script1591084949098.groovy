...
WebUI.uncheck(findTestObject('CDDS/BCM_Module_Objects/PROC_Schema_simplification/Bug_Checkbox'), FailureHandling.STOP_ON_FAILURE)
...
if (ActualGetTextAlert.contains('Bug(s) is been associated with teams. Disabling at Project level would disable at team level. Do you want to continue?')) {
    WebUI.acceptAlert()
...
WebUI.verifyMatch(Active_ChangeRequest, 'ChangeRequest\nRequirement\nAction\nAlert\nIncident ', false)

'Verify Project name is visible in the header (top left corner)'
WebUI.verifyElementNotPresent(findTestObject('CDDS/BCM_Module_Objects/PROC_Schema_simplification/Bug Default View'), GlobalVariable.Wait_Time)
