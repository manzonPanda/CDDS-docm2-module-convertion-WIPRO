...
InternalData data = findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData')
...
for (def index : (1..data.getRowNumbers())) {
    ...
    WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Login_With_Parameterized_ID'), [('Login_Id') : findTestData(
                'CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
    ...
    WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Navigate _MainModule_By_Id_to_Sub_Module_By_Text'), [('MainMenu') : findTestData(
                'CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
                'Main_Menu', index), ('SubMenu') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
    ...
    'Create Project'
    WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Create_Project'), [('ProjectName') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
                'Project_Name', val), ('ProjectAbbreviation') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
                'Project_Abbr', val), ('BusinessUnit') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
                'Business_Group', val), ('ProjectOwner') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
                'Project_Owner', val), ('AssociateSchema') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
    ...
    WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/BCM_Requirment_Edit_Functionality_Master/Common_TC_For_BCM_Module/Create_Team'), 
        [('ProjectName') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
                'Project_Name', 1), ('TeamName') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
                'Team_Name', 1), ('TeamDescription') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
                'Team_Description', 1), ('TeamBaseSite') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
    ...
    WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Requirment_Edit_Functionality_Master_Objects/BCM_State_Validation_Edit_Functionality_Assigned_State_Objects/ProjectName_Obj'), 
        findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
            'Project_Name', index))
    ...
    WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/BCM_Requirment_Edit_Functionality_Master/Common_TC_For_BCM_Module/Create_Requirement'), 
        [('On_Behalf_Of') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
                'On_Behalf_Of', index), ('Title') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
                'Title', index), ('Priority') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
                'Priority', index), ('Description') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
                'Description', index), ('Team_Name') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
    ...
    'Switch to window '
    WebUI.switchToWindowTitle(findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
            'Window_Title', 2))
    ...
    WebUI.verifyMatch(Actual_Description1, findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
    ...
    WebUI.verifyMatch(Actual_Priority, findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
            'Edit_Priority', index), false, FailureHandling.CONTINUE_ON_FAILURE)

    'Close window title'
    WebUI.closeWindowTitle(findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
            'Window_Title', 2))
    ...
    WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/BCM_Requirment_Edit_Functionality_Master/Common_TC_For_BCM_Module/Delete_Team'), 
        [('Expected_Team') : findTestData('CDDS/BCM_Module_TestData/BCM_Requirment_Edit_Functionality_Master_TestData/BCM_State_Validation_Edit_Functionality_Deferred_State_TestData').getValue(
