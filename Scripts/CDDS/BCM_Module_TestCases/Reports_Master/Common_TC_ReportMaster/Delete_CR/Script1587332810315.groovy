...
'Wait for Change Request Tab  to be visible'
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Common_TC_ReportMaster_Objects/Change_Request_Tab'), 
    GlobalVariable.Element_Timeout)

'Click on Change Requests Tab'
WebUI.click(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Common_TC_ReportMaster_Objects/Change_Request_Tab'), 
...
'Swicth to BCMProjectChangeRequestInbox frame'
WebUI.switchToFrame(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Common_TC_ReportMaster_Objects/BCMProjectChangeRequestInbox_Iframe'), 
    GlobalVariable.Element_Timeout)
