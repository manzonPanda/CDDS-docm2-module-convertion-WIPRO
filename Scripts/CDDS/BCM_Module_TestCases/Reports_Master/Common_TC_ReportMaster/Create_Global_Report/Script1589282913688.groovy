...
not_run: WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Create_Report_Objects/Create_Reports_Obj'), 
    GlobalVariable.Element_Timeout)

'Click on Create Report'
not_run: WebUI.click(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Create_Report_Objects/Create_Reports_Obj'), 
