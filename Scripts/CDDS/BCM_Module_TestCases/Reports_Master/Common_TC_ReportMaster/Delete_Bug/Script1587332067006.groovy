...
'Wait for Bugs Tab  to be visible'
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Common_TC_ReportMaster_Objects/Bugs_Tab_Obj'), 
    GlobalVariable.Element_Timeout)

'Click on Bugs Tab '
WebUI.click(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Common_TC_ReportMaster_Objects/Bugs_Tab_Obj'), 
...
'Swicth to BCMProjectBugInbox frame'
WebUI.switchToFrame(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Common_TC_ReportMaster_Objects/BCMProjectBugInbox_Iframe'), 
    GlobalVariable.Element_Timeout)
