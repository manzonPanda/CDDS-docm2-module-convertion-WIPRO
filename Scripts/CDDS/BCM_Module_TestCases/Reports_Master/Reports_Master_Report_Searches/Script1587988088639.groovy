...
WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Login_With_Parameterized_ID'), [('Login_Id') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Reports_Master_Report_Searches_TestData').getValue(
...
WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Navigate _MainModule_By_Id_to_Sub_Module_By_Text'), [('MainMenu') : findTestData(
            'CDDS/BCM_Module_TestData/Reports_Master_TestData/Reports_Master_Report_Searches_TestData').getValue('Main_Menu', 
            1), ('SubMenu') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Reports_Master_Report_Searches_TestData').getValue(
...
WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Create_Project'), [('TC_Name_Path') : '', ('ProjectName') : findTestData(
            'CDDS/BCM_Module_TestData/Reports_Master_TestData/Reports_Master_Report_Searches_TestData').getValue('Project_Name', 
            1), ('ProjectAbbreviation') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Reports_Master_Report_Searches_TestData').getValue(
            'Project_Abbr', 1), ('BusinessUnit') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Reports_Master_Report_Searches_TestData').getValue(
            'Business_Group', 1), ('ProjectOwner') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Reports_Master_Report_Searches_TestData').getValue(
            'UserID', 1), ('AssociateSchema') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Reports_Master_Report_Searches_TestData').getValue(
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Create_Bug_Objects/Select_Business_Unit_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Reports_Master_Report_Searches_TestData').getValue('Business_Group', 
        1), false)
...
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Create_Project_Objects/ProjectName_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Reports_Master_Report_Searches_TestData').getValue('Project_Name', 
        1))
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Create_Bug_Objects/Select_Show_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Reports_Master_Report_Searches_TestData').getValue('Show', 
        1), false)
...
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Create_Advanced_Report_Objects/Report_Name_Field_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Reports_Master_Report_Searches_TestData').getValue('Report_Name', 
        1))
...
'Verify table empty or no report visible'
WebUI.verifyElementVisible(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Report_Searches_Objects/No_Result_Obj'), 
...
not_run: WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Create_Report_Objects/Select_Checkbox_Obj'), 
    GlobalVariable.Element_Timeout)

'Select created report'
not_run: WebUI.uncheck(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Create_Report_Objects/Select_Checkbox_Obj'), 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyMatch(Actual_ReportName1, findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Reports_Master_Report_Searches_TestData').getValue(
        'Report_Name', 2), false, FailureHandling.CONTINUE_ON_FAILURE)
...
'Wait for Created by others checkbox element to be visible'
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Report_Searches_Objects/CreatedBy_Others_Checkbox_Obj'), 
    GlobalVariable.Element_Timeout)

'check created by others checkbox'
WebUI.check(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Report_Searches_Objects/CreatedBy_Others_Checkbox_Obj'), 
    FailureHandling.STOP_ON_FAILURE)

'Wait for Created by Me checkbox element to be visible'
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Report_Searches_Objects/CreatedBy_Me_Checkbox_Obj'), 
    GlobalVariable.Element_Timeout)

'Un check created by me checkbox'
WebUI.uncheck(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Report_Searches_Objects/CreatedBy_Me_Checkbox_Obj'), 
    FailureHandling.STOP_ON_FAILURE)

'Wait for Canned checkbox element to be visible'
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Report_Searches_Objects/Canned_Checkbox_Obj'), 
    GlobalVariable.Element_Timeout)

'Un check Canned checkbox'
WebUI.uncheck(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Report_Searches_Objects/Canned_Checkbox_Obj'), 
    FailureHandling.STOP_ON_FAILURE)
...
'Un-check created by others checkbox'
WebUI.uncheck(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Report_Searches_Objects/CreatedBy_Others_Checkbox_Obj'), 
    FailureHandling.STOP_ON_FAILURE)
...
'check created by me checkbox'
WebUI.check(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Report_Searches_Objects/CreatedBy_Me_Checkbox_Obj'), 
    FailureHandling.STOP_ON_FAILURE)
...
'Get Actual Advanced Report name from the table'
String Actual_AdvancedReportName = WebUI.getText(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Unshare_Report_Objects/Get_ReportName_Obj'))

'Trim getting Advanced report name'
String Actual_AdvancedReportName1 = Actual_AdvancedReportName.trim()

'Verify Actual and Expected Advanced report name matched'
WebUI.verifyMatch(Actual_AdvancedReportName1, findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Reports_Master_Report_Searches_TestData').getValue(
        'Report_Name', 3), false, FailureHandling.CONTINUE_ON_FAILURE)

'Get Actual Report name from the table'
String Actual_ReportName2 = WebUI.getText(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Report_Searches_Objects/Get_SimpleReport_Obj'))

'Trim getting report name'
String Actual_ReportName3 = Actual_ReportName2.trim()

'Verify Actual and Expected report name matched'
WebUI.verifyMatch(Actual_ReportName3, findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Reports_Master_Report_Searches_TestData').getValue(
        'Report_Name', 2), false, FailureHandling.CONTINUE_ON_FAILURE)
...
'check Canned checkbox'
WebUI.check(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Report_Searches_Objects/Canned_Checkbox_Obj'), 
    FailureHandling.STOP_ON_FAILURE)
...
'wait for advanced report checkbox to be visible'
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Report_Searches_Objects/Verify_Checkbox1_Obj'), 
    GlobalVariable.Element_Timeout)

'Verify Advanced report checkbox to be visible'
WebUI.verifyElementVisible(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Report_Searches_Objects/Verify_Checkbox1_Obj'), 
    FailureHandling.CONTINUE_ON_FAILURE)

'Verify Advanced report checkbox to be visible'
WebUI.verifyElementVisible(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Report_Searches_Objects/Verify_Checkbox2_Obj'), 
    FailureHandling.CONTINUE_ON_FAILURE)

'Verify Advanced report to be visible'
WebUI.verifyElementVisible(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Report_Searches_Objects/Verify_AdvancedReport_Obj'), 
    FailureHandling.OPTIONAL)

'Verify Simple report to be visible'
WebUI.verifyElementVisible(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Report_Searches_Objects/Verify_SimpleReport_Obj'), 
    FailureHandling.OPTIONAL)
...
WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/Reports_Master/Common_TC_ReportMaster/Delete_Report'), [('Expected_ReportName') : findTestData(
            'CDDS/BCM_Module_TestData/Reports_Master_TestData/Reports_Master_Report_Searches_TestData').getValue('Report_Name', 
