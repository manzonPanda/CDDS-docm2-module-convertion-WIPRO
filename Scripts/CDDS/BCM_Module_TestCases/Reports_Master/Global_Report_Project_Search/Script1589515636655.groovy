...
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Create_GLobal_Report/Project_Name'), findTestData(
        'CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue('ProjectName', 1))
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Global_Report_Project_Search_Objects/Business_Unit_Dropdown'), 
    findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue('BusinessUnit', 
        1), false)
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Create_GLobal_Report/Show_Project'), 
    findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue('ShowProjects', 
        2), false)
...
def ProjectName = findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue(
    'ProjectName', 1)
...
WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/Reports_Master/Common_TC_ReportMaster/Project_Search'), [('ProjectName') : findTestData(
            'CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue('ProjectName', 2), ('ShowProjects') : findTestData(
            'CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue('ShowProjects', 2)
        , ('BusinessUnit') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue(
            'BusinessUnit', 1), ('ProjectAbbreviation') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue(
            'ProjectAbbreviation', 1), ('ProjectOwner') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue(
...
WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/Reports_Master/Common_TC_ReportMaster/Project_Search'), [('ProjectName') : findTestData(
            'CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue('ProjectName', 1), ('ShowProjects') : findTestData(
            'CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue('ShowProjects', 1)
        , ('BusinessUnit') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue(
            'BusinessUnit', 1), ('ProjectAbbreviation') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue(
            'ProjectAbbreviation', 1), ('ProjectOwner') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue(
...
WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/Reports_Master/Common_TC_ReportMaster/Project_Search'), [('ProjectName') : findTestData(
        ...
        , ('BusinessUnit') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue(
            'BusinessUnit', 1), ('ProjectAbbreviation') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue(
            'ProjectAbbreviation', 2), ('ProjectOwner') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue(
            'ProjectOwner', 1)], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/Reports_Master/Common_TC_ReportMaster/Project_Search'), [('ProjectName') : findTestData(
            'CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue('ProjectName', 3), ('ShowProjects') : findTestData(
            'CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue('ShowProjects', 2)
        , ('BusinessUnit') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue(
            'BusinessUnit', 2), ('ProjectAbbreviation') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue(
            'ProjectAbbreviation', 3), ('ProjectOwner') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue(
...
WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/Reports_Master/Common_TC_ReportMaster/Project_Search'), [('ProjectName') : findTestData(
            'CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue('ProjectName', 4), ('ShowProjects') : findTestData(
            'CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue('ShowProjects', 2)
        , ('BusinessUnit') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue(
            'BusinessUnit', 2), ('ProjectAbbreviation') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue(
            'ProjectAbbreviation', 4), ('ProjectOwner') : findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Global_Report_Project_Search').getValue(
            'ProjectOwner', 3)], FailureHandling.STOP_ON_FAILURE)
