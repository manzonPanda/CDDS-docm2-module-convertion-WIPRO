...
for (def index : (1..data.getRowNumbers())) {
    ...
    WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Create_Bug_Objects/Title_Field_Obj'), 
        findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/CDDS_7493_CreateChangeRequest_1_BCM_State_Validation').getValue(
            'BCMTitle', index))
    ...
    WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Create_CR_Objects/Select_Priority_Obj'), 
        findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/CDDS_7493_CreateChangeRequest_1_BCM_State_Validation').getValue(
            'BCMCustomerPriority', index), false)
    ...
    WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Create_CR_Objects/Sub_Classification_Obj'), 
        findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/CDDS_7493_CreateChangeRequest_1_BCM_State_Validation').getValue(
            'BCMSubClassification', index), FailureHandling.STOP_ON_FAILURE)
    ...
    WebUI.selectOptionByLabel(findTestObject('CDDS/Generic_Objects/Common_Objects/Type_Dropdown'), findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/CDDS_7493_CreateChangeRequest_1_BCM_State_Validation').getValue(
    ...
    WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/CDDS_7493_CreateChangeRequest_1_BCM_State_Validation/State_Dropdown'), 
        GlobalVariable.Element_Timeout)

    WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/CDDS_7493_CreateChangeRequest_1_BCM_State_Validation/State_Dropdown'), 
        findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/CDDS_7493_CreateChangeRequest_1_BCM_State_Validation').getValue(
            'Transition', index), false)
    ...
    WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/BCM_State_Validation_Edit_Bug/Assigned_To_Fix'), 
        findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/CDDS_7493_CreateChangeRequest_1_BCM_State_Validation').getValue(
            'Assignee', index), FailureHandling.STOP_ON_FAILURE)
    ...
    WebUI.verifyMatch(Actual_State, findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/CDDS_7493_CreateChangeRequest_1_BCM_State_Validation').getValue(
            'State', index), false, FailureHandling.STOP_ON_FAILURE)
