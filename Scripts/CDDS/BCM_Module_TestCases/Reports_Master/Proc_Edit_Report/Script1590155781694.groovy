...
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Proc_Edit_Report/Edit_Option'), 
    GlobalVariable.Element_Timeout)

'Click on Create Report'
WebUI.click(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Proc_Edit_Report/Edit_Option'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyMatch(Actual_Report1, findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Proc_Create_Report').getValue(
...
WebUI.verifyMatch(Actual_Project2[1], findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/BCM_State_Validation_CreateIC').getValue(
...
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Proc_Edit_Report/Description_Checkbox'), 
    GlobalVariable.Element_Timeout)

'check Need By Date checkbox '
WebUI.check(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Proc_Edit_Report/Description_Checkbox'))
