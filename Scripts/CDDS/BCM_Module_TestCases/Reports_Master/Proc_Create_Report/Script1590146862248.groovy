...
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Proc_Create_Report/Create_Report'), 
    GlobalVariable.Element_Timeout)

'Click on Create Report'
WebUI.click(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Proc_Create_Report/Create_Report'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Reports_Master_Create_Report_Objects/Report_Name_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Proc_Create_Report').getValue('Report_Name', 1))
...
println(Actual_Project1[1])

'Verify actual and expected project name matched'
WebUI.verifyMatch(Actual_Project1[1], findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/BCM_State_Validation_CreateIC').getValue(
...
WebUI.switchToFrame(findTestObject('CDDS/BCM_Module_Objects/Reports_Master_Objects/Proc_Create_Report/Frame_ListDisplay'), 
    GlobalVariable.Element_Timeout)
...
WebUI.verifyMatch(Actual_CRType1, findTestData('CDDS/BCM_Module_TestData/Reports_Master_TestData/Proc_Create_CR').getValue(
        'BCMDescription', 1), false, FailureHandling.OPTIONAL)
