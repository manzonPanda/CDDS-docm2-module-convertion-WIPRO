...
WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Login_With_Parameterized_ID'), [('Login_Id') : findTestData('CDDS/BCM_Module_TestData/BCM_SMC_TestData/Base_Data_Creation').getValue(
            'SetMember_External', 1)], FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/BCM_SMC/BCM_SMC_BCM_SCM_Non_Member_Non_TI_Program_Objects/Show_Projects_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/BCM_SMC_TestData/Team Member_Non TI-User_Program').getValue('ShowProject', 1), 
    false)
...
WebUI.verifyElementPresent(ProjectNameObj, GlobalVariable.Wait_Time, FailureHandling.CONTINUE_ON_FAILURE)
...
'Wait for ProjectName element to be visible'
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/BCM_SMC/BCM_SMC_BCM_SCM_Non_Member_Non_TI_Program_Objects/Show_Projects_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/BCM_SMC_TestData/Team Member_Non TI-User_Program').getValue('ShowProject', 2), 
    false)
...
'Verify Actions Button not present'
...
not_run: WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/BCM_SMC/BCM_SMC_BCM_SCM_Non_Member_Non_TI_Program_Objects/MyProgram_CheckBox_Obj'), 
    GlobalVariable.Element_Timeout)

'Uncheck My Program'
not_run: WebUI.click(findTestObject('CDDS/BCM_Module_Objects/BCM_SMC/BCM_SMC_BCM_SCM_Non_Member_Non_TI_Program_Objects/MyProgram_CheckBox_Obj'), 
    FailureHandling.STOP_ON_FAILURE)
