...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/BCM_SMC/BCM_SMC_Create_Program_Project_Objects/Show_Projects_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/BCM_SMC_TestData/Design Team Member_TI-User_IC Component').getValue('ShowProject', 
        2), false)
...
'Wait for  Select ProjectName  element to be visible'
WebUI.verifyElementPresent(ProjectNameObj, GlobalVariable.Element_Timeout, FailureHandling.CONTINUE_ON_FAILURE)
...
'Verify Create BCM Option is present'
...
def TeamName = findTestData('CDDS/BCM_Module_TestData/BCM_SMC_TestData/Design Team Member_TI-User_IC Component').getValue(
    'Team_Name', 1)
...
WebUI.verifyElementNotPresent(findTestObject('CDDS/Generic_Objects/Bug_Add_Member/AddMember_Obj'), GlobalVariable.Element_Timeout, 
    FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/BCM_SMC/BCM_SMC_Non_Member_TI_User_IC Component_Objects/OwningBU_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/BCM_SMC_TestData/Design Team Member_TI-User_IC Component').getValue('BusinessUnit', 
        1), false)
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/BCM_SMC/BCM_SMC_Non_Member_TI_User_IC Component_Objects/IP_Classification_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/BCM_SMC_TestData/Design Team Member_TI-User_IC Component').getValue('IPClassification', 
        1), false)
...
'Wait for  Select ProjectName  element to be visible'
WebUI.verifyElementPresent(ICCompNameObj, GlobalVariable.Wait_Time, FailureHandling.CONTINUE_ON_FAILURE)
