...
String Filepath = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadMassCreateIncident').getValue('File_path', 
    1)
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/Verify _project/StateCheck_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadMassCreateIncident').getValue('State', 1), false)
...
WebUI.verifyMatch(Actual_BugTitle_trim, findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadMassCreateIncident').getValue(
...
'Verify actual and expected value'
WebUI.verifyMatch(Actual_State, findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadMassCreateIncident').getValue(
