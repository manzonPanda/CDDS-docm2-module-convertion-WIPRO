...
'login'
not_run: WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Login_With_Parameterized_ID'), [('Login_Id') : findTestData(
            'CDDS/BCM_Module_TestData/MassUpdate_Data/Create_CM-Label-IN-IC_MASSUPDATE_2').getValue('UserId', 1)], FailureHandling.STOP_ON_FAILURE)
...
String CMlabel = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/Create_CM-Label-IN-IC_MASSUPDATE_2').getValue('Label', 
    1)
