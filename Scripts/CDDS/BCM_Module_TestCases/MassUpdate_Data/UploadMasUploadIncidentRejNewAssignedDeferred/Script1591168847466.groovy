...
String Filepath = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadMasUploadIncidentRejNewAssignedDeferred').getValue(
    'File_path', 1)
...
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/Verify _project/Keyword_Obj'), findTestData(
        'CDDS/BCM_Module_TestData/MassUpdate_Data/UploadMassCreateIncident1').getValue('Title', 1))
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/Verify _project/StateCheck_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadMasUploadIncidentRejNewAssignedDeferred').getValue('State', 
        1), false)
...
'Assign a value to string'
String title = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadMassCreateIncident1').getValue('Title', 1)

'Assign a value to state'
String state = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadMasUploadIncidentRejNewAssignedDeferred').getValue(
    'State', 2)
