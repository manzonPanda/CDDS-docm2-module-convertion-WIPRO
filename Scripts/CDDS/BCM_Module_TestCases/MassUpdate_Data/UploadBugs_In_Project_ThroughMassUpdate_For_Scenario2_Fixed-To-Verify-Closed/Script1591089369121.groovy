...
String Filepath = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadBugs_In_Project_ThroughMassUpdate_For_Scenario2_Fixed-To-Verify-Closed').getValue(
    'File_path', 1)
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/Verify _project/StateCheck_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadBugs_In_Project_ThroughMassUpdate_For_Scenario2_Fixed-To-Verify-Closed').getValue(
        'State', 1), false)
...
'Assign a value to string'
String title = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadBugs_In_Project_ThroughMassCreate_For_Scenario2').getValue(
    'Title', 1)

'Assign a value to state'
String state = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadBugs_In_Project_ThroughMassUpdate_For_Scenario2_Fixed-To-Verify-Closed').getValue(
    'State', 2)
