...
String Filepath = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadBugs__In_Project_ThroughMassUpdate_From_Fixed_To_Verify').getValue(
    'File_path', 1)
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/Verify _project/StateCheck_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadBugs__In_Project_ThroughMassUpdate_From_Fixed_To_Verify').getValue(
        'State', 1), false)
...
String state = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadBugs__In_Project_ThroughMassUpdate_From_Fixed_To_Verify').getValue(
    'State', 2)
