...
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/MassUpdate_Data/UploadBugs_In_Project_ThroughMassUpdate_Scenario5/Bug_Option'), 
    GlobalVariable.Element_Timeout)

'Click on  Bug button '
WebUI.click(findTestObject('CDDS/BCM_Module_Objects/MassUpdate_Data/UploadBugs_In_Project_ThroughMassUpdate_Scenario5/Bug_Option'), 
    FailureHandling.STOP_ON_FAILURE)
...
String Filepath = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadBugs_In_Project_ThroughMassCreate_For_Scenario2').getValue(
    'File_path', 1)
...
not_run: WebUI.click(findTestObject('CDDS/BCM_Module_Objects/MassUpdate_Data/UploadCRs_In_Project_ThroughMassUpdate/Next_btn_Obj'), 
...
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/Verify _project/Keyword_Obj'), findTestData(
        'CDDS/BCM_Module_TestData/MassUpdate_Data/UploadBugs_In_Project_ThroughMassCreate_For_Scenario2').getValue('Title', 
        1))
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/Verify _project/StateCheck_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadBugs_In_Project_ThroughMassCreate_For_Scenario2').getValue(
        'State', 1), false)

'wait for statecheck'
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/MassUpdate_Data/UploadBugs_In_Project_ThroughMassUpdate_Scenario5/SeverityCheck'), 
    GlobalVariable.Element_Timeout, FailureHandling.STOP_ON_FAILURE)

'Select statecheck'
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/MassUpdate_Data/UploadBugs_In_Project_ThroughMassUpdate_Scenario5/SeverityCheck'), 
    findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadBugs_In_Project_ThroughMassCreate_For_Scenario2').getValue(
        'Severity', 1), false)
...
WebUI.verifyMatch(Actual_BugTitle_trim, findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadBugs_In_Project_ThroughMassCreate_For_Scenario2').getValue(
...
'Verify actual and expected value'
WebUI.verifyMatch(Actual_State, findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadBugs_In_Project_ThroughMassCreate_For_Scenario2').getValue(
