...
String Filepath = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/EditBugs_In_Project_ThroughMassUpdate_For_Scenario1_Deferred-To-Assigned').getValue(
    'File_path', 1)
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/Verify _project/StateCheck_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/EditBugs_In_Project_ThroughMassUpdate_For_Scenario1_Deferred-To-Assigned').getValue(
        'State', 1), false)
...
String state = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/EditBugs_In_Project_ThroughMassUpdate_For_Scenario1_Deferred-To-Assigned').getValue(
    'State', 2)
