...
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/Verify _project/Keyword_Obj'), findTestData(
        'CDDS/BCM_Module_TestData/MassUpdate_Data/Change_The_RootCause_Bug_State').getValue('Title', 1))
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/Verify _project/StateCheck_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/Change_The_RootCause_Bug_State').getValue('State', 1), false)
...
'Click on find'
WebUI.check(findTestObject('CDDS/Generic_Objects/Common_Objects/Table_Checkbox'))
...
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/MassUpdate_Data/Change_The_RootCause_Bug_State/Edit_Change_State'), 
    GlobalVariable.Element_Timeout)

'Click on  Upload Mass Update XLS... button '
WebUI.click(findTestObject('CDDS/BCM_Module_Objects/MassUpdate_Data/Change_The_RootCause_Bug_State/Edit_Change_State'), 
    FailureHandling.STOP_ON_FAILURE)
...
'wait for statecheck'
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/MassUpdate_Data/Change_The_RootCause_Bug_State/State_dropdown'), 
    GlobalVariable.Element_Timeout, FailureHandling.STOP_ON_FAILURE)

'Select statecheck'
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/MassUpdate_Data/Change_The_RootCause_Bug_State/State_dropdown'), 
    findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/Change_The_RootCause_Bug_State').getValue('State', 2), false)

'wait for keyword'
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/MassUpdate_Data/Change_The_RootCause_Bug_State/TI_Internal_Comments'), 
    GlobalVariable.Element_Timeout)

'Enter keyword'
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/MassUpdate_Data/Change_The_RootCause_Bug_State/TI_Internal_Comments'), 
    findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/Change_The_RootCause_Bug_State').getValue('Comments', 1))

'Switch to default'
WebUI.switchToDefaultContent()

'Wait for next  button element to be visible'
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/MassUpdate_Data/Change_The_RootCause_Bug_State/Done_button'), 
    GlobalVariable.Element_Timeout)

'Click on  next button '
WebUI.click(findTestObject('CDDS/BCM_Module_Objects/MassUpdate_Data/Change_The_RootCause_Bug_State/Done_button'), FailureHandling.OPTIONAL)
...
'Select statecheck'
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/Verify _project/StateCheck_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/Change_The_RootCause_Bug_State').getValue('State', 3), false)
...
'Assign a value to string'
String title = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/Change_The_RootCause_Bug_State').getValue('Title', 
    1)

'Assign a value to state'
String state = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/Change_The_RootCause_Bug_State').getValue('State', 
    4)
