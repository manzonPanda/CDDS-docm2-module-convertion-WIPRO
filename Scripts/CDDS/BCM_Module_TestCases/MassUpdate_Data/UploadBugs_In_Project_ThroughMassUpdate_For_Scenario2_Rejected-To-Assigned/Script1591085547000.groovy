...
String Filepath = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadBugs_In_Project_ThroughMassUpdate_For_Scenario2_Rejected-To-Assigned').getValue(
    'File_path', 1)
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/Verify _project/StateCheck_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadBugs_In_Project_ThroughMassUpdate_For_Scenario2_Rejected-To-Assigned').getValue(
        'State', 1), false)
...
String state = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadBugs_In_Project_ThroughMassUpdate_For_Scenario2_Rejected-To-Assigned').getValue(
    'State', 2)
