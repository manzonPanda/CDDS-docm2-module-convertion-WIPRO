...
WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Login_URL'), [('Login_Id') : findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/Create_IC_MASSUPDATE_BCM_State_Validation').getValue(
...
String Filepath = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/EditBugs_In_Project_ThroughMassUpdate_For_Scenario1_Fixed-verify-Closed').getValue(
    'File_path', 1)
...
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/GemBCMElem_Createproject/Verify _project/StateCheck_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/EditBugs_In_Project_ThroughMassUpdate_For_Scenario1_Fixed-verify-Closed').getValue(
        'State', 1), false)
...
'Assign a value to string'
String title = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadBugs_In_Project_ThroughMassUpdate_For_Scenario1').getValue(
    'Title', 1)

'Assign a value to state'
String state = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/EditBugs_In_Project_ThroughMassUpdate_For_Scenario1_Fixed-verify-Closed').getValue(
    'State', 2)
...
WebUI.verifyElementVisible(titleObj, FailureHandling.OPTIONAL)
