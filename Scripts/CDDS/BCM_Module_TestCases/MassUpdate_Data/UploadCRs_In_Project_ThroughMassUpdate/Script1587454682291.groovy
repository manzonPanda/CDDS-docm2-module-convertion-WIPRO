...
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/MassUpdate_Data/UploadCRs_In_Project_ThroughMassUpdate/Change Request_Obj'), 
    GlobalVariable.Element_Timeout)

'Click on  CR button '
WebUI.click(findTestObject('CDDS/BCM_Module_Objects/MassUpdate_Data/UploadCRs_In_Project_ThroughMassUpdate/Change Request_Obj'), 
    FailureHandling.STOP_ON_FAILURE)
...
String Filepath = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadCRs_In_Project_ThroughMassUpdate').getValue(
    'File_path', 1)
...
'assign state\r\n'
String state = findTestData('CDDS/BCM_Module_TestData/MassUpdate_Data/UploadCRs_In_Project_ThroughMassUpdate').getValue(
    'State', 1)

'creating a team dynamic xpath'
String titleXpath = ((('(//a[contains(.,"' + title) + '")])[1]/../..//td[contains(text(),"') + state) + '")]'
...
WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/MassUpdate_Data/UploadCRs__Project_MassUpdate__New_To_Assigned'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/MassUpdate_Data/UploadCRs_Project_MassUpdate_Assigned_To_Assessed'), 
    [:], FailureHandling.STOP_ON_FAILURE)
