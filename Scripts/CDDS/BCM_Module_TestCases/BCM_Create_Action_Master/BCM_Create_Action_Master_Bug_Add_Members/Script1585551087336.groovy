...
'Create Project'
WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Create_Project'), [('ProjectName') : findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
            'ProjectName', val), ('ProjectAbbreviation') : findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
            'ProjectAbbreviation', val), ('BusinessUnit') : findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
            'BusinessUnit', val), ('ProjectOwner') : findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
            'ProjectOwner', val), ('AssociateSchema') : findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
            'AssociateSchema', val), ('TC_Name_Path') : findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
            'TC_Name_Path', val), ('TC_Name_Path1') : findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
            'TC_Name_Path1', val)], FailureHandling.STOP_ON_FAILURE)

'Create a Team'
WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Create_Team'), [('ProjectName') : findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
            'ProjectName', val), ('TeamName') : findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
            'TeamName', val), ('TeamDescription') : findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
            'TeamDescription', val), ('TeamBaseSite') : findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
...
WebUI.waitForElementPresent(findTestObject('CDDS/BCM_Module_Objects/BCM_Create_Action_Master_Objects/BCM_Create_Action_Master_Bug_Add_Members_Objects/MemberAccess_Obj'), 
    GlobalVariable.Element_Timeout)

'Click on Member Access'
WebUI.click(findTestObject('CDDS/BCM_Module_Objects/BCM_Create_Action_Master_Objects/BCM_Create_Action_Master_Bug_Add_Members_Objects/MemberAccess_Obj'))

'Add Member '
WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Bug_Add_Member'), [('SetMember') : findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
            'SetMember', 1)], FailureHandling.STOP_ON_FAILURE)

'Add Member '
WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Bug_Add_Member'), [('SetMember') : findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
            'SetMember', 2)], FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/BCM_Create_Action_Master_Objects/BCM_Create_Action_Master_Bug_Add_Members_Objects/Member_Type_Obj'), 
    GlobalVariable.Element_Timeout)

'Select Member Type as Person'
WebUI.selectOptionByLabel(findTestObject('CDDS/BCM_Module_Objects/BCM_Create_Action_Master_Objects/BCM_Create_Action_Master_Bug_Add_Members_Objects/Member_Type_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
        'MemberType', 1), false)

'Wait for SearchUserId element to be visible'
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/BCM_Create_Action_Master_Objects/BCM_Create_Action_Master_Bug_Add_Members_Objects/Search_UserId_Obj'), 
    GlobalVariable.Element_Timeout)

'Set the SearchUserId'
WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Create_Action_Master_Objects/BCM_Create_Action_Master_Bug_Add_Members_Objects/Search_UserId_Obj'), 
    findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
        'SetMember', 1), FailureHandling.STOP_ON_FAILURE)

'Wait for Find Buttton element to be visible'
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/BCM_Create_Action_Master_Objects/BCM_Create_Action_Master_Bug_Add_Members_Objects/Find_Btn_Obj'), 
    GlobalVariable.Element_Timeout)

'Click on Find btn'
WebUI.click(findTestObject('CDDS/BCM_Module_Objects/BCM_Create_Action_Master_Objects/BCM_Create_Action_Master_Bug_Add_Members_Objects/Find_Btn_Obj'))
...
WebUI.waitForElementVisible(findTestObject('CDDS/BCM_Module_Objects/BCM_Create_Action_Master_Objects/BCM_Create_Action_Master_Bug_Add_Members_Objects/Verify_MemberId_Obj'), 
    GlobalVariable.Element_Timeout)

'Get VerifyMemberId '
ActualMemberId1 = WebUI.getText(findTestObject('CDDS/BCM_Module_Objects/BCM_Create_Action_Master_Objects/BCM_Create_Action_Master_Bug_Add_Members_Objects/Verify_MemberId_Obj'))

'Verify  Equal ActualVerifyMemberId with Expected MemberId'
WebUI.verifyEqual(ActualMemberId1, findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
        'SetMember', 1))
...
'Get VerifyMemberId '
ActualMemberId2 = WebUI.getText(findTestObject('CDDS/BCM_Module_Objects/BCM_Create_Action_Master_Objects/BCM_Create_Action_Master_Bug_Add_Members_Objects/Verify_MemberId_Obj'))

'Verify  Equal ActualVerifyMemberId with Expected MemberId'
WebUI.verifyEqual(ActualMemberId2, findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
        'SetMember', 2))
...
WebUI.setText(findTestObject('CDDS/Generic_Objects/Create_Team_Objects/ProjectName_Obj'), findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
        'ProjectName', 1))
...
def ProjectName = findTestData('CDDS/BCM_Module_TestData/BCM_Create_Action_Master_TestData/BCM_Create_Action_Master_Bug_Add_Members').getValue(
    'ProjectName', 1)
