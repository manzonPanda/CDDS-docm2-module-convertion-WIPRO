...
InternalData data = findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Deffered_State')
...
for (def index : (1..data.getRowNumbers())) {
    ...
    WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Login_With_Parameterized_ID'), [('Login_Id') : findTestData(
                'CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Deffered_State').getValue(
                'UserID', index)], FailureHandling.STOP_ON_FAILURE)

    'Assign a role to variable'
    String role = findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Deffered_State').getValue(
        'Role', index)

    'Print the role'
    println('BCM_State_Validation_Edit_Functionality_Deffered_State || ' + role)

    WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/BCM_Incident_Edit_Functionality_Master/Edit project'), 
        [('Criteria') : '', ('Type') : findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Deffered_State').getValue(
                'Type', index), ('Select_project') : findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Deffered_State').getValue(
                'Project', index), ('Project_Name') : findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Deffered_State').getValue(
                'Project_Name', index), ('BU') : findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Deffered_State').getValue(
                'BU', index), ('Schema') : findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Deffered_State').getValue(
                ...
                'Title_Incident', index), ('Classification') : findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Deffered_State').getValue(
    ...
    if (index > 3) {
        ...
        WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Incident_Edit_Functionality_Master/Create_Incident/Assignee_Obj'), 
            findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Deffered_State').getValue(
    ...
    println(('BCM_State_Validation_Edit_Functionality_Deffered_State || ' + role) + ' is verifed')
