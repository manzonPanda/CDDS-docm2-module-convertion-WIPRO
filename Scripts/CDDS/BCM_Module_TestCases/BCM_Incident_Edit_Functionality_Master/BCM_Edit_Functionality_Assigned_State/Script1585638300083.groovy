...
InternalData data = findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Assigned_State')
'run the for loop to get the all data'

for (def index : (1..data.getRowNumbers())) {
'login to CDDS with Non Support Role'
WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Login_With_Parameterized_ID'), [('Login_Id') : findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Assigned_State').getValue(
            'UserID', index)], FailureHandling.STOP_ON_FAILURE)

'Assign a role to variable'
String role = findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Assigned_State').getValue(
    'Role', index)
...
WebUI.callTestCase(findTestCase('CDDS/BCM_Module_TestCases/BCM_Incident_Edit_Functionality_Master/Edit project'), 
    [('Criteria') : '', ('Type') : findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Assigned_State').getValue(
            'Type', index), ('Select_project') : findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Assigned_State').getValue(
            'Project', index), ('Project_Name') : findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Assigned_State').getValue(
            'Project_Name', index), ('BU') : findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Assigned_State').getValue(
            'BU', index), ('Schema') : findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Assigned_State').getValue(
            'Associate_schema', index), ('Owner') : GlobalVariable.Non_Support_Role_Username, ('State_type') : findTestData(
            'CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Assigned_State').getValue(
...
if (index >3) {
    ...
    WebUI.setText(findTestObject('CDDS/BCM_Module_Objects/BCM_Incident_Edit_Functionality_Master/Create_Incident/Assignee_Obj'), 
         findTestData('CDDS/BCM_Module_TestData/BCM_Incident_Edit_Functionality_Master/BCM_Edit_Functionality_Assigned_State').getValue(
