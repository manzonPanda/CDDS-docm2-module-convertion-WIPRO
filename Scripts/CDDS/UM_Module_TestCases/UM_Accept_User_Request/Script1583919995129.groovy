...
WebUI.waitForElementVisible(findTestObject('CDDS/UM_Module_Objects/UM_Accept_User_Request/CreateUsersReq_Obj'), GlobalVariable.Wait_Time, 
    FailureHandling.OPTIONAL)

'Click on  Create User Request'
WebUI.click(findTestObject('CDDS/UM_Module_Objects/UM_Accept_User_Request/CreateUsersReq_Obj'), FailureHandling.OPTIONAL)
