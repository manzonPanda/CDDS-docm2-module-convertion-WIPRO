...
WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/Create_User'), [('Company') : findTestData('CDDS/UM_Module_TestData/UM_Accept_User_Request').getValue(
            'Company', 2), ('BusinessUnit') : findTestData('CDDS/UM_Module_TestData/UM_Accept_User_Request').getValue('BusinessUnit', 
            2), ('AID_XID') : findTestData('CDDS/UM_Module_TestData/UM_Accept_User_Request').getValue('AID_XID', 2), ('CDDSRoles') : findTestData(
            'CDDS/UM_Module_TestData/UM_Accept_User_Request').getValue('CDDSRoles', 2), ('FileSite') : findTestData('CDDS/UM_Module_TestData/UM_Accept_User_Request').getValue(
            'FileSite', 2)], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/UserId_Set'), [('UserID') : findTestData('CDDS/UM_Module_TestData/UM_Accept_User_Request').getValue(
            'AID_XID', 2)], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('CDDS/Generic_TestCases/User_Request_Form'), [('Company') : findTestData('CDDS/UM_Module_TestData/UM_Accept_User_Request').getValue(
            'Company', 2), ('BusinessUnit') : findTestData('CDDS/UM_Module_TestData/UM_Accept_User_Request').getValue('BusinessUnit', 
            2), ('UserId') : findTestData('CDDS/UM_Module_TestData/UM_Accept_User_Request').getValue('AID_XID2', 2), ('CDDSRoles') : findTestData(
            'CDDS/UM_Module_TestData/UM_Accept_User_Request').getValue('CDDSRoles', 2), ('FileSites') : findTestData('CDDS/UM_Module_TestData/UM_Accept_User_Request').getValue(
            'FileSite', 2)], FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByLabel(findTestObject('CDDS/UM_Module_Objects/UM_Accept_User_Request/Search_ Company_Dropdown_Obj'), 
    findTestData('CDDS/UM_Module_TestData/UM_Accept_User_Request').getValue('Company', 2), false)
...
WebUI.selectOptionByValue(findTestObject('CDDS/UM_Module_Objects/UM_Accept_User_Request/State_Select_Obj'), findTestData(
        'CDDS/UM_Module_TestData/UM_Accept_User_Request').getValue('State', 2), false)
...
WebUI.verifyEqual(ActualSearchBusinessUnit.trim(), findTestData('CDDS/UM_Module_TestData/UM_Accept_User_Request').getValue(
        'BusinessUnit', 2), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyEqual(ActualSearchCompany.trim(), findTestData('CDDS/UM_Module_TestData/UM_Accept_User_Request').getValue('Company', 
        2), FailureHandling.CONTINUE_ON_FAILURE)
